                        ...
                        <Grid item md={12} lg={11} xl={10} className="header_fixed">
                            <Grid container>
                                <Grid item md={3} lg={2} xl={2}>
                                    <div className="logo">
                                        <h1><Link to="#"><b>T<br />H<br />E</b>Book<span>Mellow Kiki</span></Link></h1>
                                    </div>
                                </Grid>
                                    ...
                                    <div className="collapse navbar-collapse" id="bs-megadropdown-tabs">
                                        <ul className="nav navbar-nav ">
                                            ...
                                            <li className="dropdown ">
                                                <Link to="/kitchen" className="dropdown-toggle  hyper"><span>Book<b className="caret" /></span></Link>
                                                <ul className="dropdown-menu multi">
                                                    <div className="row">
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Adventure</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Classic</Link></li>
                                                                <li><Link to="/kitchen"> <i className="fa fa-angle-right" aria-hidden="true" />Crime, Mystery &amp;Thrillers</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Erotic Fiction</Link></li>
                                                            </ul>
                                                        </div>
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Fiction In Translation</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Graphic Novels</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Historical Fiction</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Horror &amp; Ghost Stories</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Modern Fiction</Link></li>
                                                            </ul>
                                                        </div>
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Myth&amp; Legen</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Religious</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Romance</Link></li>
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" />Science Fiction &amp; Fantansy</Link></li>
                                                            </ul>
                                                        </div>
                                                        <div className="col-sm-3 w3l">
                                                            <Link to="/kitchen"><img src="images/" className="img-responsive" alt="" /></Link>
                                                        </div>
                                            ...
                                            <li className="dropdown ">
                                                <Link to="/kitchen" className="dropdown-toggle  hyper"><span>E-Book<b className="caret" /></span></Link>
                                                <ul className="dropdown-menu multi">
                                                    <div className="row">
                                                        <div className="col-sm-3">
                                                            <ul className="multi-column-dropdown">
                                                                <li><Link to="/kitchen"><i className="fa fa-angle-right" aria-hidden="true" /></Link></li>
                                            ...
                                            <li className="dropdown ">
                                                <Link to="/" className="dropdown-toggle  hyper"><span>Our Services<b className="caret" /></span></Link>
                                                
                                            </li>

                                            <li className="dropdown">
                                                <Link to="#" className="dropdown-toggle hyper" data-toggle="dropdown"><span>Contact Us<b className="caret" /></span></Link>
