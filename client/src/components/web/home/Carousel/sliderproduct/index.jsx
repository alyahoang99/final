                    ...
                    <Slider {...settingsMobile}>
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="/" data-toggle="modal" data-target="#myModal1" className="offer-img">
                                    <img src="/images/a16.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Virginia Woolf and The East</Link></h6>
                                    </div>
                                    <div className="mid-2">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">SOul And River</Link></h6>
                                    </div>
                                    <div className="mid-2">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">The Valley of Lost Secrets</Link></h6>
                                    </div>
                                    <div className="mid-2">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">The Valey Lost of Secrets</Link></h6>
                                    </div>
                                    <div className="mid-2">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Book</Link></h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>$4.00</label><em className="item_price">$3.50</em></p>
                                        <div className="block">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal4" className="offer-img">
                                    <img src="images/book9.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                    ...
                    <Slider {...settings}>
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                ...
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">THe East</Link></h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>$2.00</label><em className="item_price">$1.50</em></p>
                                        <div className="block">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal2" className="offer-img">
                                    <img src="images/a17.jpg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">ORder of The Phoenix</Link></h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>$10.00</label><em className="item_price">$9.00</em></p>
                                        <div className="block">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal3" className="offer-img">
                                    <img src="images/a14.jpeg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">Quidditch</Link></h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>$3.00</label><em className="item_price">$2.00</em></p>
                                        <div className="block">
                        ...
                        <div className="col-md-3 m-wthree">
                            <div className="col-m">
                                <Link to="#" data-toggle="modal" data-target="#myModal4" className="offer-img">
                                    <img src="images/a13.jpeg" className="img-responsive" alt="" />
                                    <div className="offer"><p><span>Offer</span></p></div>
                                </Link>
                                <div className="mid-1">
                                    <div className="women">
                                        <h6><Link to="/product-details">The Bard</Link></h6>
                                    </div>
                                    <div className="mid-2">
                                        <p><label>$4.00</label><em className="item_price">$3.50</em></p>
                                        <div className="block">
